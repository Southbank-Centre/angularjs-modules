(function() {
  ...
  describe('Factory: scContentGet', function() {
    ...
    var scContentGet;
    var scContentSettings;
    var $httpBackend;
    var $rootScope;

    beforeEach(module('scContent'));

    beforeEach(inject(function(_scContentGet_, _scContentSettings_, _$httpBackend_, _$rootScope_) {
      scContentGet = _scContentGet_;
      scContentSettings = _scContentSettings_;
    ...
    describe('Method: item', function() {
      ...
      it('should return the requested single item data if the request was well-formed and successful', function() {
        ...
        $httpBackend
          .expectGET(scContentSettings.BASE_URL + '/api/event/event-title-here-1234.json?_source=name,startDate&pretty=true')
    ...
    describe('Method: items', function() {
      ...
      it('should return the requested items data if the request was well-formed and successful', function() {
        ...
        $httpBackend
          .expectGET(scContentSettings.BASE_URL + '/api/event.json?pretty=true&size=20')
